...
use Heritage\Routing\Route as BaseRoute;
use Heritage\Routing\RouteAction;
use Heritage\Support\Collection;
use Heritage\Support\Js;
use Heritage\Support\Str;
use Ugarit\SerializableClosure\Support\ReflectionClosure;
use ReflectionClass;
...
class Route
{
    ...
    public function controllerPath(): string
    {
        ...
        if ($controller === '\\Closure') {
            ...
            if (str_contains($path, 'ugarit-serializable-closure')) {
